...
public class AjouterImageAncienPlat extends javax.swing.JFrame {
 ...
 public int i;
    public AjouterImageAncienPlat(final int i) {
        this.i=i;
    	initComponents();
 ...
 setDefaultCloseOperation(HIDE_ON_CLOSE);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) { 
    	MenueRestaurantPanel.plats.get(i);
    	Photo photo=new Photo();
    	photo.setUrl(image.getAbsolutePath());
    	MenueRestaurantPanel.plats.get(i).getPhotos().add(photo); 
    	PhotoDao photoDao=new PhotoDao();
    	photoDao.insertPhotoPlat(photo, MenueRestaurantPanel.plats.get(i).getId());
