...
public class FrameAddIngredient extends javax.swing.JFrame {
 ...
 setDefaultCloseOperation(HIDE_ON_CLOSE);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) { 
    	...
    	if(!FramePlat.choice){
    		...
    		ingredientDao.insertIngredient(ingredient,MenueRestaurantPanel.plats.get(MenueRestaurantPanel.selectedPlat).getId());
    	}
    	myFrame.dispose();
//    	if(sommeImages>0){
