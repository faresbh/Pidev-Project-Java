			...
			public void actionPerformed(ActionEvent e) {
				...
				if (livraison.getEtat().equals("refuse")) {
					...
					int reponse = JOptionPane
							.showConfirmDialog(
									null,
									"cette livraison est dèja refusée voulez vous la supprimer ?",
					...
					if (x == 1) {
						JOptionPane
								.showMessageDialog(null,
										"refus de la livraison avec succés",
										"refus", 1);
					} else {
						JOptionPane.showMessageDialog(null,
								"Erreur lors de la modification", "Error", 0,
		...
		btnNotifierLeClient.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (livraison.getEtat().equals("valide")) {
					...
					try {
						...
						message.setRecipients(Message.RecipientType.TO,
								InternetAddress.parse(livraison.getClient()
										.getMail()));
						message.setSubject("Livraison acceptée pour le "
						...
						JOptionPane
								.showMessageDialog(null,
										"Un Mail est envoyé à l'adresse mail du client");
					...
					JOptionPane.showMessageDialog(null,
							"cette livraison n'est pas acceptée ");
				}
			}
